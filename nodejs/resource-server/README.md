...
For more details, see the _Red Hat build of Keycloak_ documentation about how to [create a new realm](https://access.redhat.com/documentation/en-us/red_hat_build_of_keycloak/24.0/html-single/server_administration_guide/index#proc-creating-a-realm_server_administration_guide).
...
```
"keycloak-connect": "file:/<path-to-the-downloaded-file>/rhbk-24.0.5-nodejs-adapter.tar.gz"
```
...
* [Red Hat build of Keycloak Node.js Adapter](https://access.redhat.com/documentation/en-us/red_hat_build_of_keycloak/24.0/html-single/securing_applications_and_services_guide/index#_javascript_adapter)
